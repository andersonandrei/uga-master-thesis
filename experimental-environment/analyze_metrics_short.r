...
# out_short_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_03-05-2019/qarnotNodeSched/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_03-05-2019/qarnotNodeSchedAndrei/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_03-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_03-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_03-05-2019/qarnotNodeSchedFullReplicate/out_short_jobs_times.csv", header=T,strip.white=TRUE);
...
# out_short_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_10-05-2019/qarnotNodeSched/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_10-05-2019/qarnotNodeSchedAndrei/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_10-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_10-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_10-05-2019/qarnotNodeSchedFullReplicate/out_short_jobs_times.csv", header=T,strip.white=TRUE);
...
# out_short_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_17-05-2019/qarnotNodeSched/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_17-05-2019/qarnotNodeSchedAndrei/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_17-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_17-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_17-05-2019/qarnotNodeSchedFullReplicate/out_short_jobs_times.csv", header=T,strip.white=TRUE);
...
# out_short_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_24-05-2019/qarnotNodeSched/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_24-05-2019/qarnotNodeSchedAndrei/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_24-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_24-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_short_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_24-05-2019/qarnotNodeSchedFullReplicate/out_short_jobs_times.csv", header=T,strip.white=TRUE);
