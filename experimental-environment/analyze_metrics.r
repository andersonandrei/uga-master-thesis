...
# out_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_03-05-2019/qarnotNodeSched/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_03-05-2019/qarnotNodeSchedAndrei/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_03-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_03-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_03-05-2019/qarnotNodeSchedFullReplicate/out_jobs_times.csv", header=T,strip.white=TRUE);
...
# out_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_10-05-2019/qarnotNodeSched/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_10-05-2019/qarnotNodeSchedAndrei/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_10-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_10-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_10-05-2019/qarnotNodeSchedFullReplicate/out_jobs_times.csv", header=T,strip.white=TRUE);
...
# out_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_17-05-2019/qarnotNodeSched/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_17-05-2019/qarnotNodeSchedAndrei/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_17-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_17-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_17-05-2019/qarnotNodeSchedFullReplicate/out_jobs_times.csv", header=T,strip.white=TRUE);
...
# out_jobs_times.csv
jobs_time_standard <- read.csv("output/1w_24-05-2019/qarnotNodeSched/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_location_based <- read.csv("output/1w_24-05-2019/qarnotNodeSchedAndrei/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate3LeastLoaded <- read.csv("output/1w_24-05-2019/qarnotNodeSchedReplicate3LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_replicate10LeastLoaded <- read.csv("output/1w_24-05-2019/qarnotNodeSchedReplicate10LeastLoaded/out_jobs_times.csv", header=T,strip.white=TRUE);
jobs_time_fullrep <- read.csv("output/1w_24-05-2019/qarnotNodeSchedFullReplicate/out_jobs_times.csv", header=T,strip.white=TRUE);
...
df_all_weeks_data <- df_all_weeks %>% select(Workload, 
                                             ...
                                             nb_jobs_killed,
                                             scheduling_time,
                                             nb_rejected_instances_during_dispatch,
                                             nb_burn_jobs_created,
                                             success_rate
                                             )
...
p <- 
    ...
    ggsave('full_metrics_mean_waitingTime.png')
...
p <- 
    ...
    theme(
        ...
        #panel.grid.minor = element_blank())+
        #axis.text.x=element_blank(),
    ggsave('full_metrics_max_waitingTime.png')
...
p <- 
    ...
    theme(
        ...
        #panel.grid.minor = element_blank())+
        #axis.text.x=element_blank(),
    ggsave('full_metrics_max_bsd_slowdown.png')
...
p <- 
    ...
    theme(
        ...
        #panel.grid.minor = element_blank())+
        #axis.text.x=element_blank(),
    ggsave('full_metrics_mean_bsd_slowdown.png')
...
p <- 
    ...
    theme(
        ...
        #panel.grid.minor = element_blank())+
        #axis.text.x=element_blank(),
    ggsave('full_metrics_nb_transfers.png')
...
p <- 
    ...
    theme(
        ...
        #panel.grid.minor = element_blank())+
        #axis.text.x=element_blank(),
    ggsave('full_metrics_transferred_data.png')



#write.csv(df_plot, file = "metrics.csv")

print(df_all_gathered)

df_plot <- subset(df_all_gathered, 
                  #metrics == 'makespan' |
                  #metrics == 'max_slowdown' |
                  #metrics == 'max_waitting_time' |
                  #metrics == 'mean_waiting_time' |
                  #metrics == 'scheduling_time' |
                  #metrics == 'simulation_time' |
                 metrics == 'nb_preempted_jobs'|
                 metrics == 'nb_jobs_success'|
                 #metrics == 'nb_jobs_rejected'|
                 metrics == 'nb_jobs_killed'|
                 metrics == 'scheduling_time'|
                 metrics == 'nb_burn_jobs_created' |
                 metrics == 'success_rate')
                 #metrics == 'nb_rejected_instances_during_dispatch')#|
                  #metrics == 'consumed_joules')

labels <- c(nb_burn_jobs_created = 'burn jobs created',
            nb_preempted_jobs = 'preempted jobs',
            nb_jobs_success = 'sucessful jobs',
            success_rate = 'sucess rate',
            nb_jobs_killed = 'killed jobs',
...
p <- 
    ...
    geom_bar(aes(fill = Scheduler), position = "dodge", stat="identity") +
    scale_fill_viridis_d() + 
    facet_wrap(~ metrics, scales = "free_y", ncol = 2, labeller = labeller(metrics = labels)) +
    #scale_y_continuous(limits = c(0,NA), expand = c(0.5,0)) +
    scale_y_continuous(limits = c(0,NA), expand = expand_scale(mult = .1)) +
    #scale_x_discrete(expand = c(0.30,0.30)) +
    ggtitle("") + #"Comparison metrics for different Schedulers ") +
